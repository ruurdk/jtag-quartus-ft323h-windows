 ...
 */
static inline void buf_set_u32(uint8_t *_buffer, unsigned int first, unsigned int num, uint32_t value)
{
...
static inline void bit_copy(uint8_t *dst, unsigned int dst_offset, const uint8_t *src,	unsigned int src_offset, unsigned bit_count)
{
...
typedef std::list<bit_copy_queue_entry> bit_copy_queue;
